...
public class ModBlocks {
    public static final Block LIFARMIAN_TABLE = registerBlock("lifarmian_table",
            new Block(FabricBlockSettings.of(Material.WOOD).strength(2.5f).hardness(2.5f).requiresTool()));
    ...
    public static final Block CREATURE_CARRIER_BLOCK = registerBlock("creature_carrier_block",
            new Block(FabricBlockSettings.of(Material.METAL).strength(3.5f).hardness(3.5f).requiresTool()));
    public static final Block PACKED_BOOKSHELF = registerBlock("packed_bookshelf",
            new Block(FabricBlockSettings.of(Material.WOOD).strength(4f).hardness(4f).requiresTool()));
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registry.ITEM, new Identifier(villagers_empowered.MOD_ID, name),
