...
public class ModVillagers {
    ...
    public static final VillagerProfession FLASONIC = registerProfession("flasonic",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(villagers_empowered.MOD_ID, "flasonic_poi")));
    ...
    public static final VillagerProfession LIFARMIAN = registerProfession("lifarmian",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(villagers_empowered.MOD_ID, "lifarmian_poi")));
    ...
    public static final VillagerProfession CREATURE_CARRIER = registerProfession("creature_carrier",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(villagers_empowered.MOD_ID, "creature_carrier_poi")));
    ...
    public static final VillagerProfession PACKED_LIBRARIAN = registerProfession("packed_librarian",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(villagers_empowered.MOD_ID, "packed_librarian_poi")));

    public static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(villagers_empowered.MOD_ID, name),
    ...
    public static void registerTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(CREATURE_CARRIER,1,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.ZOMBIE_SPAWN_EGG, 1), 4, 3, 0.03f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.SKELETON_SPAWN_EGG, 1), 4, 3, 0.03f)));
                });
        TradeOfferHelper.registerVillagerOffers(CREATURE_CARRIER,2,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.CREEPER_SPAWN_EGG, 1), 4, 15, 0.15f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.SPIDER_SPAWN_EGG, 1), 4, 15, 0.15f)));
                });
        TradeOfferHelper.registerVillagerOffers(CREATURE_CARRIER,3,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.COW_SPAWN_EGG, 1), 4, 20, 0.2f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.SHEEP_SPAWN_EGG, 1), 4, 20, 0.2f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.BEE_SPAWN_EGG, 1), 4, 25, 0.25f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.CHICKEN_SPAWN_EGG, 1), 4, 25, 0.25f)));
                });
        TradeOfferHelper.registerVillagerOffers(CREATURE_CARRIER,4,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(ModItems.CHARGED_CREEPER_SPAWN_EGG, 1), 4, 25, 0.25f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.SLIME_SPAWN_EGG, 1), 4, 25, 0.25f)));
                });
        TradeOfferHelper.registerVillagerOffers(CREATURE_CARRIER,5,
                factories -> {
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.WITHER_SKELETON_SPAWN_EGG, 1), 4, 30, 0.3f)));
                    factories.add(((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG, 1), new ItemStack(Items.VILLAGER_SPAWN_EGG, 1), 4, 30, 0.3f)));
                });
